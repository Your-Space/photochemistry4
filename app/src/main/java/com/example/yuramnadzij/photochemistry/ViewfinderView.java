...
public final class ViewfinderView extends View implements View.OnTouchListener {
    ...
    private static final int MIN_FRAME_WIDTH = 30; // originally 240
    private static final int MIN_FRAME_HEIGHT = 30; // originally 240
    ...
    public ViewfinderView(Context context, AttributeSet attrs, int defStyle) {
        ...
        paint = new Paint(Paint.ANTI_ALIAS_FLAG);
        maskColor = Color.argb(40, 0, 0, 0);
        frameColor = Color.argb(0, 0, 0, 0);
        cornerColor = Color.WHITE;
        WindowManager manager = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
        Display display = manager.getDefaultDisplay();
        int width = display.getWidth();
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(frame.left - 5, frame.top - 5, frame.left + 30,
                frame.top, paint);
        canvas.drawRect(frame.left - 5, frame.top, frame.left, frame.top + 30,
                paint);
        canvas.drawRect(frame.right - 30, frame.top - 5, frame.right + 5,
                frame.top, paint);
        canvas.drawRect(frame.right, frame.top - 5, frame.right + 5,
                frame.top + 30, paint);
        canvas.drawRect(frame.left - 5, frame.bottom, frame.left + 30,
                frame.bottom + 5, paint);
        canvas.drawRect(frame.left - 5, frame.bottom - 30, frame.left,
                frame.bottom, paint);
        canvas.drawRect(frame.right - 30, frame.bottom, frame.right + 5,
                frame.bottom + 5, paint);
        canvas.drawRect(frame.right, frame.bottom - 30, frame.right + 5,
                frame.bottom + 5, paint);
